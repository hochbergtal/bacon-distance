...
def iter_title_actors(title_principals_filename: str) -> Generator[TitleActor]:
...
def iter_title_names(title_basics_filename: str) -> Generator[IdName]:
...
def iter_actor_names(name_basics_filename: str) -> Generator[IdName]:
